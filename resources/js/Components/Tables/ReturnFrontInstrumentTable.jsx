...
export default function ReturnFrontInstrumentTable({ return_instruments, meta, onSortable }) {
    return (
                            ...
                            <TableCell>
                                <div className='flex items-center gap-x-1'>
                                        <Button variant="blue" size="sm" asChild>
                                            <Link href={route('front.return-instruments.show', [return_instrument.return_instrument_code])}>
