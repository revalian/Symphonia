    ...
    const handleSearch = async (query) => {
        ...
        if (query.length > 2) {
            try {
                ...
                onSearch(response.data.data, query);
            } catch (error) {
            ...
            <div className="container mx-auto flex items-center justify-between px-4 py-4">
               ...
               <div className="ml-auto flex items-center space-x-4">
                    <div className="relative flex items-center">
                        ...
                        />
                        <button className="absolute right-2 top-1/2 transform -translate-y-1/2 text-orange-500 hover:text-orange-700">
                            ...
                            <div className="relative ms-3">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link  href={route('front.loans.index')} as="button">
                                            Peminjaman
                                        </Dropdown.Link>
                                        <Dropdown.Link href={route('front.return-instruments.index')} as="button">
                                            Pengembalian
                                        </Dropdown.Link>
