...
export default function Edit(props) {
    ...
    const { data, setData, reset, post, processing, errors } = useForm({
        ...
        phone: props.page_data.user.phone ?? '',
        avatar: null,
        gender: props.page_data.user.gender ?? null,
        date_of_birth: props.page_data.user.date_of_birth ?? '',
        address: props.page_data.user.address ?? '',
