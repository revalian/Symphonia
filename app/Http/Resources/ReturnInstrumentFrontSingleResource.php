...
class ReturnInstrumentFrontSingleResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'instrument' => $this->whenLoaded('instrument',[
                ...
                'image' => $this->instrument?->image ? Storage::url($this->instrument?->image): null,
            ...
            'return_instrument_check' => $this->whenLoaded('returnInstrumentCheck',[
                'condition' => $this->returnInstrumentCheck?->condition,
                'notes' => $this->returnInstrumentCheck?->notes,
            ]),
        ];
    }
}
